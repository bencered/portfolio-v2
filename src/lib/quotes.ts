export const quotes: [string, string][] = [
    ...
    ["Freedom of thought and action matter, and are guaranteed, because the future is not.", "Hadrian Marlowe"],
    ...
    ["I had dreamed of this moment since I was a boy, since I'd learned that Delos was not the world but a planet island in it.", "Hadrian Marlowe"],
    ...
    ["I've heard that art is the only truly useless creation - intended for no mechanical purpose. Valued only because of the perception of the people who view it. The thing is, everything is useless, intrinsically. Nothing has value unless we grant it that value. Any object can be worth whatever we decide it to be worth.", "Wit"],
    ...
    ["Don't wait for the tide to dip your feet in.", "Beabadoobee"]
];
